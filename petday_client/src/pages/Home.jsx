      ...
      <main>
        ...
        >
          ...
          >
            ...
            />
            <div className="carousel-indicators1 container">
              <div className="banner_services_wrap row" style={{}}>
                <div className="col-md-3">
                  <div className="iconbox_item iconbox_overicon">
                    ...
                    <div className="item_content">
                      <h3 className="item_title mb-0">Online Consultaion</h3>
                    </div>
                    <a className="item_global_link" href="appointment" />
                  </div>
                </div>
                <div className="col-md-3">
                  <div className="iconbox_item iconbox_overicon">
                    ...
                    <a className="item_global_link" href="groomers" />
                  </div>
                </div>
                <div className="col-md-3">
                  <div className="iconbox_item iconbox_overicon">
                    ...
                    <div className="item_content">
                      <h3 className="item_title mb-0">Vets Near You</h3>
                    </div>
                    <a className="item_global_link" href="vets" />
                  </div>
                </div>
                <div className="col-md-3">
                  <div className="iconbox_item iconbox_overicon">
                    ...
                    <div className="item_content">
                      <h3 className="item_title mb-0">Buy Products</h3>
                    </div>
                    <a className="item_global_link" href="shop" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="carousel-inner">
              <div className="carousel-item carousel-item-next carousel-item-start">
                <img
                  ...
                  src="http://103.131.196.44/~petday/public_html/assets/images/banner/taking-care-pet.jpg"
                  alt="Los Angeles"
                  className="d-block"
                />
              ...
              <div className="carousel-item active carousel-item-start">
                <img
                  style={{ height: 800, width: "100%" }}
                  src="http://103.131.196.44/~petday/public_html/assets/images/banner/attractive-veterinarian-using-vet-clinic.jpg"
                  alt="Chicago"
                  className="d-block"
                />
                {/*<div class="carousel-caption">*/}
